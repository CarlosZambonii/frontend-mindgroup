  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4" style={{ backgroundColor: '#0f172a' }}>
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <button className="bg-teal-500 text-white w-full py-2 rounded-md mb-4">Entrar</button>
        <button className="bg-teal-500 text-white w-full py-2 rounded-md">Criar conta</button>
      </div>
    </div>
  );
};
